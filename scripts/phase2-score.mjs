...
async function loadModel() {
  const json = JSON.parse(readFileSync(resolve(root, ".phase2/model/asl-model.json"), "utf8"));
...
const third = JSON.parse(readFileSync(resolve(root, ".phase2/third.json"), "utf8"));
...
const aaron = JSON.parse(readFileSync(resolve(root, ".phase2/aaron.json"), "utf8"));
